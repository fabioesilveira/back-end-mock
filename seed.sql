...
('Pit Stop Classic / 350kcal', 5.00, 'sandwiches', 'https://i.ibb.co/HpFzXNX0/hamburguer.jpg', 'Simple and fast—grilled beef patty, fresh lettuce, tomato, and cheese. Perfect for a quick fuel-up'),
...
('Double Gear / 510kcal', 9.00, 'sandwiches', 'https://i.ibb.co/prZW744b/gallery-216da7fc-8884-434c-be8d-80ed24e5e26c.jpg', 'Two juicy beef patties, double cheese, lettuce, tomato, and extra layers for double the power. Built for big appetites'),
...
('Chocolate Milkshake / 420kcal', 4.00, 'desserts', 'https://uproxx.com/wp-content/uploads/2022/08/menuproduct-Hot_Fudge_Classic_Shake.webp', 'Rich, creamy, and full of chocolatey goodness. Blended to perfection for the ultimate sweet refreshment.'),
